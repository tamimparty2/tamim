...
let attendMode = document.getElementsByName("attend-mode");
...
textWrapper3.innerHTML = textWrapper3.textContent.replace(
  /([^\x00]|\w)/g,
  "<span class='letter3' style='opacity: 0'>$&</span>"
);
...
function displayAcknowledgement(direction) {
  if (direction == "normal") {
...
function fadeInFadeOutAck(fadeOut, fadeIn) {
  anime
    .timeline({
      easing: "easeOutSine",
      duration: 500,
...
document.body.addEventListener("focusin", function (e) {
  document.querySelectorAll(".text-red-500").forEach(function (item) {
